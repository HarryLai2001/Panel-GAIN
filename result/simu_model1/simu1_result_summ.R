...
for(method in methods) {
  pred = read.xlsx(glue("{method}/simu1 T_pre={T_pre} reps_res.xlsx"),
                   sheet = "pred_err")
  ...
  gt_est = read.xlsx(glue("{method}/simu1 T_pre={T_pre} reps_res.xlsx"),
                     sheet = "gt_est") %>%
...
write.xlsx(cmp_res, glue("simu1 cmp_res T_pre={T_pre}.xlsx"))
...
ggsave(glue("simu1 gt_eff_err T_pre={T_pre}.png"), width = 14, height = 12)