...
from panel_gain2 import Generator, Discriminator
from trainer_panelgain2 import Trainer
...
if __name__ == '__main__':
    ...
    for rep in range(reps_num):
        ...
        df, data_loader = load_data(f"../../data/simu_model1/T_pre={T_pre}/simu1 rep={rep}.xlsx", batch_size=128)

        generator = Generator(t_dim=T_obs, h_dim=T_obs, num_ffns=4, num_groups=6, embed_dim=3)
        discriminator = Discriminator(t_dim=T_obs, h_dim=T_obs, num_ffns=4)
    ...
    with pd.ExcelWriter(f"../../result/simu_model1/Panel-GAIN2/simu1 T_pre={T_pre} reps_res.xlsx",
    ...
    for rep in range(reps_num):
        ...
        df, data_loader = load_data(f"../../data/simu_model2/T_pre={T_pre}/simu2 rep={rep}.xlsx", batch_size=128)
    ...
    with pd.ExcelWriter(f"../../result/simu_model2/Panel-GAIN2/simu2 T_pre={T_pre} reps_res.xlsx", engine='openpyxl') as writer:
        pred_err.to_excel(writer, sheet_name="pred_err", index=False)
        gt_est_df.to_excel(writer, sheet_name="gt_est", index=False)
